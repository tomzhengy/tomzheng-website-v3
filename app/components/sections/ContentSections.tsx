  ...
  return (
    <>
      <section aria-labelledby="current-activities" className="mt-6 mb-6">
          <h2 id="current-activities" className="text-xl mb-2">in my free time i'm</h2>
        <ul className="list-disc pl-5 space-y-1">
            ...
            <li className="text-xl">scaling <a href="https://www.sdx.community/chapters/ucsd" target="_blank" rel="noopener noreferrer" className="underline decoration-gray-300 hover:decoration-white transition-colors">SDx</a> at ucsd.</li>
            <li className="text-xl">investing in my friends.</li>
        </ul>
      </section>

      <section aria-labelledby="thinking thoughts" className="mt-6 mb-12">
